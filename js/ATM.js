...
//     display.innerHTML = '<h4>' + Users.User1 + '</h4>';
...
function pin(){
    ...
    if(Number(cardNum.value) === Users.User1.pinNum){
        nonChar = "";
...
function fastCash(){
    display.innerHTML = '<h4>What amount would you like to Withdraw out of Fast Cash?: </h4><br>'+ '<h4 class="FCb1">20</h4> <h4 class="FCb4">80</h4><h4 class="FCb2">40</h4><h4 class= "FCb5">100</h4><h4  class="FCb3"  >60</h4><h4 class="FCb6">120</h4 ></div>';
    var change = document.getElementsByTagName("button");
